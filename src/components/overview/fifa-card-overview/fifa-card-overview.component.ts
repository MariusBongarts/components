...
const componentCSS = require('./fifa-card-overview.component.scss');

@customElement('fifa-card-overview')
  ...
  render() {
    ...
    <div class="row my-2 pt-5 d-flex justify-content-center">
      ...
      <div class="col-12 col-lg-6 align-self-center">
        <marius-fifa-card playerName=${this.playerName} pac=${this.pac} sho=${this.sho} pas=${this.pas} dri=${this.dri} def=${this.def}
          phy=${this.phy} overall=${this.overall} position=${this.position} playerImgUrl=${this.playerImgUrl} nationLogoUrl=${this.nationLogoUrl}
          clubLogoUrl=${this.clubLogoUrl} sm=${this.sm} wf=${this.wf}>
        </marius-fifa-card>
      </div>
    </div>
`;
